...
//            "	</tr>\n" +
//            "	<tr>\n" +
            "		<td><i class=\"icon-chevron-left\"  ng-click=\"incrementHours()\"></i></td>\n" +
            "		<td class=\"control-group\" ng-class=\"{'error': invalidHours}\"><input type=\"text\" style=\"width:40px\" ng-model=\"hours\" ng-change=\"updateHours()\" class=\"span1 text-center\" ng-mousewheel=\"incrementHours()\" ng-readonly=\"readonlyInput\" maxlength=\"2\"></td>\n" +
           "		<td><i class=\"icon-chevron-right\" ng-click=\"decrementHours()\"></i></td>\n" +

            "		<td><i class=\"icon-chevron-left\"  ng-click=\"incrementMinutes()\"></i></td>\n" +
            "		<td class=\"control-group\" ng-class=\"{'error': invalidMinutes}\"><input type=\"text\" style=\"width:40px\" ng-model=\"minutes\" ng-change=\"updateMinutes()\" class=\"span1 text-center\" ng-readonly=\"readonlyInput\" maxlength=\"2\"></td>\n" +
            "		<td><i class=\"icon-chevron-right\" ng-click=\"decrementMinutes()\"></i></td>\n" +
